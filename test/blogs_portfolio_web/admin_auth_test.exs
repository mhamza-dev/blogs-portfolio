defmodule BlogsPortfolioWeb.AdminAuthTest do
  use BlogsPortfolioWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias BlogsPortfolio.Backoffice
  alias BlogsPortfolioWeb.AdminAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, BlogsPortfolioWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      BlogsPortfolioWeb.Endpoint.subscribe(live_socket_id)
